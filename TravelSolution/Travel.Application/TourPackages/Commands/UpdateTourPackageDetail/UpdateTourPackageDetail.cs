...
{
    public class UpdateTourPackageDetail: IRequest
    {
    ...
    public class UpdateTourPackageDetailCommandHandler : IRequestHandler<UpdateTourPackageDetail>
    {
        ...
        public async Task<Unit> Handle(UpdateTourPackageDetail request, CancellationToken cancellationToken)
        {
